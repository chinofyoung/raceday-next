        ...
        <PageWrapper className="min-h-[80vh] flex items-center justify-center">
            <div className="text-center space-y-8 max-w-lg mx-auto">
                <div className="space-y-2">
                    ...
                    <h2 className="text-4xl font-bold tracking-tight text-white">System Cramp!</h2>
                    <p className="text-text-muted font-medium">
                        Something went wrong while loading this page. Don't worry, even elite athletes have bad days.
                    </p>
                    <p className="text-xs font-mono text-text-muted/30 pt-4">Error: {error.message || "Unknown error"}</p>
                </div>

                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Button onClick={() => reset()} variant="primary" className="h-14 px-8 font-bold">
                        <RefreshCcw size={20} className="mr-2" /> Try Again
                    </Button>
                    <Button asChild variant="outline" className="h-14 px-8 font-bold">
