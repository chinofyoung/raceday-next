            ...
            <Card className="max-w-2xl w-full p-10 md:p-16 text-center space-y-10 bg-surface/40 backdrop-blur-xl border-white/5 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-text-muted font-medium">Your details have been saved. One last step to secure your slot!</p>
                    </div>
                </div>
                ...
                <div className="relative z-10 bg-black/20 rounded-3xl p-8 border border-white/5 space-y-6">
                    <div className="flex items-center justify-between text-left">
                        <div className="space-y-1">
                            <p className="text-xs font-semibold uppercase tracking-wider text-text-muted">Next Step</p>
                            <h3 className="text-xl font-bold text-white uppercase">Secure Payment</h3>
                        </div>
                        <CreditCard className="text-primary" size={32} />
                    </div>

                    <p className="text-sm text-text-muted leading-relaxed text-left border-l-2 border-primary pl-4">
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-4 pt-4">
                    <Button variant="primary" size="lg" className="flex-1 font-bold uppercase bg-cta hover:bg-cta-hover shadow-xl shadow-cta/20 group" asChild>
                        <Link href={`/dashboard/events`}>
                            Proceed to Dashboard <ChevronRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                        </Link>
                    </Button>
                    <Button variant="outline" size="lg" className="flex-1 font-bold uppercase group" asChild>
                        <Link href="/">
