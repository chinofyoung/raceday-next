...
export function ProfileCompletionCard({ completion }: ProfileCompletionCardProps) {
    ...
    return (
        <Card className="bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/30 p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 md:gap-8 shadow-xl hover:shadow-2xl transition-all relative overflow-hidden cursor-pointer">
            ...
            <Link href="/dashboard/settings" className="absolute inset-0 z-0" aria-label="Complete your profile" />
            
            <div className="relative w-24 h-24 sm:w-28 sm:h-28 flex items-center justify-center shrink-0 drop-shadow-lg z-10 pointer-events-none">
