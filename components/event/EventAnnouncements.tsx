...
export function EventAnnouncements({ announcements }: EventAnnouncementsProps) {
    return (
        <div id="announcements" className="space-y-8 px-4 md:px-0">
            <h2 className="text-3xl font-bold tracking-tight text-white">Latest <span className="text-primary">Updates</span></h2>
            {announcements.length > 0 ? (
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex justify-between items-start mb-4 gap-4">
                                        <div className="min-w-0">
                                            <h3 className="text-xl md:text-2xl font-bold tracking-tight text-white truncate md:whitespace-normal">{announcement.title}</h3>
                                    ...
                                    <p className="text-sm md:text-base text-text-muted leading-relaxed whitespace-pre-wrap font-normal">
                ...
                <div className="py-16 text-center bg-surface/20 rounded-2xl border border-dashed border-white/10 flex flex-col items-center gap-4">
                    <Megaphone className="text-text-muted opacity-20" size={48} />
                    <p className="text-text-muted font-medium">No updates at this time</p>
                </div>
            )}
        </div>
    );
